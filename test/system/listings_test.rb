...
class ListingsTest < ApplicationSystemTestCase
  ...
  test "creating a Listing" do
    ...
    fill_in "Console compatibility", with: @listing.console_compatibility
    fill_in "Cosmetic condition", with: @listing.cosmetic_condition
    fill_in "Description", with: @listing.description
    fill_in "Functional condition", with: @listing.functional_condition
